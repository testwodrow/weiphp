...
return array(
		// 数据库配置
        'DB_TYPE'   => 'mysql', // 数据库类型
        'DB_HOST'   => \config\ConfigLocal::$db['host'], // 服务器地址
        'DB_NAME'   => \config\ConfigLocal::$db['name'], // 数据库名
        'DB_USER'   => \config\ConfigLocal::$db['user'], // 用户名
        'DB_PWD'    => \config\ConfigLocal::$db['pwd'],  // 密码
        'DB_PORT'   => '3306', // 端口
		...
		// 系统数据加密设置
		'DATA_AUTH_KEY' => 'jlRSc@M#<J3&pb=iO^*2wm0`nYy:LeBEq4sar?8N', // 默认数据加密KEY
